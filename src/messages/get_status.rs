...
mod tests {
    ...
    fn get_status_request_to_bytes() {
        let expected = [
            0x17, 0x20, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    fn get_status_response_to_bytes() {
        let expected = [
            0x17, 0x20, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0x39, 0x00, 0x00, 0x00, 0x02, 0x01,
            0x03, 0x01, 0xaa, 0xe8, 0x5d, 0x00, 0x20, 0x19, 0x04, 0x19, 0x17, 0x00, 0x09, 0x06,
            0x01, 0x00, 0x01, 0x01, 0x00, 0x00, 0x01, 0x01, 0x09, // Last: SystemError
            0x14, 0x37, 0x02, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2b, 0x04, 0x01,
            0x19, 0x04, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ];
    ...
    fn get_status_response_from_bytes() {
        let bytes: [u8; 64] = [
            0x17, 0x20, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0x39, 0x00, 0x00, 0x00, 0x01, 0x00,
            0x03, 0x01, 0xaa, 0xe8, 0x5d, 0x00, 0x20, 0x19, 0x04, 0x19, 0x17, 0x00, 0x09, 0x06,
            0x01, 0x00, 0x01, 0x01, 0x00, 0x00, 0x01, 0x01, 0x09, 0x14, 0x37, 0x02, 0x11, 0x00,
            0x00, 0x00, 0x21, 0x00, 0x00, 0x00, 0x2b, 0x04, 0x01, 0x19, 0x04, 0x20, 0x00, 0x00,
            0x93, 0x26, 0x04, 0x88, 0x08, 0x92, 0x00, 0x00,
        ];
